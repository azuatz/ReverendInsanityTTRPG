...
tags:
  ...
  - npc
aliases:
  - Elenco — Geração da Caverna
escopo: campanha
---

# 🎭 Elenco — Geração da Caverna

> ⚠️ **Isto é um exemplo, não o cenário oficial.** Estes NPCs existem pra você canibalizar: pegue a estrutura (uma autoridade, um par rival, alguém que depende do grupo), troque nomes, motivações e segredos, ou jogue tudo fora e escreva os seus. Ver [[🛠️ Como Criar Sua Lore|Como Criar Sua Lore]].

O grupo de jovens discípulos do Clã Gu Yue que passa pela Cerimônia do Despertar junto com os personagens dos jogadores. Alguns viram aliados, alguns viram rivais, um vira o vilão de um arco inteiro — a mesa decide isso jogando, não aqui. Nenhum destes nomes existe no romance; é elenco original desta mesa, mas nasceram sob as mesmas leis de cultivo e Gu.

Cada um está listado com a tendência de Caminho que vai se firmar quando (e se) ele chegar à [[♾️ A Ascensão Imortal|Ascensão Imortal]] — nos ranks mortais isso é só um estilo, não uma ficha travada.

---

## Gu Yue Chao — o primo calculista
...
## Wu Xin Yan — a lâmina impaciente
...
## Shen Lu — a serva que ninguém treinou

Não nasceu no clã — foi trazida ainda criança como serva de um ramo empobrecido, e ninguém esperava que ela abrisse Abertura nenhuma. Abriu, pequena, e por puro instinto de sobrevivência aprendeu a fazer o pouco que tem render mais que deveria.

- **Tendência de Caminho:** Veneno — não tem força pra vencer de frente, então garante que ninguém sobreviva a um confronto direto com ela sem pagar por dias.
- **Gu característico:** uma coleção de Gu de toxina fraca, cada um quase inofensivo sozinho, refinados a partir do que ela conseguia caçar escondida.
- **Golpe Matador — "Mil Cortes Pequenos":** núcleo é a soma de três venenos incompatíveis entre si que, juntos, o corpo do alvo não consegue processar; apoio é um Gu de disfarce de cheiro que evita que o alvo perceba a primeira dose. Contragolpe: Shen Lu precisa manusear os três venenos sem proteção — se errar a sequência, é ela quem adoece.
- **Gancho de mesa:** a rival mais fácil de subestimar e a mais perigosa de fazer inimiga de verdade.

## Gu Yue Rou — o rosto que se lembra de todos
...
## Ancião Gu Yue Ren — o mestre da Cerimônia

Não é da geração dos personagens — é quem conduz a Cerimônia do Despertar e, por isso, o primeiro adulto de peso que os jogadores encontram. Rank 5, décadas de experiência, e um Caminho já cristalizado há tempo.

- **Caminho firmado:** Formação — não é o cultivador mais forte em duelo individual, mas nenhum combate no território dele acontece nos termos do inimigo.
- **Gu característico:** uma rede de Gu de arranjo instalados permanentemente sob a Montanha Qing Mao, que ele pode ativar em conjunto — o motivo pelo qual ninguém invade o clã de frente.
- **Gancho de mesa:** mentor, não obstáculo — mas também o adulto que primeiro vai notar se um personagem estiver escondendo algo grande.

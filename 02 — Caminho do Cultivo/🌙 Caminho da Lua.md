...
É Yin puro. Combina naturalmente com Alma, Sombra, Água e Sangue; briga com Fogo e Luz.

---

## ☾ A Fase Lunar — o único dial do Caminho

O mestre declara a fase no começo de toda cena externa, em voz alta, antes de qualquer rolagem. **É a única coisa que o Caminho pede que se lembre.**
...
Um cultivador de Lua **escolhe a hora da luta**, e um inimigo que entende isso arrasta o confronto para dentro de uma mina ou espera a lua nova. Metade da preparação deste Caminho é calendário. Ver [[🕵️ Preparação e Informação|Preparação e Informação]].

---

## O que o Caminho faz

**1. Lâminas de Lua (corte à distância).** O ataque padrão. Crescentes de luz que cortam sem massa — atravessam armadura física mal, mas **ignoram cobertura parcial** (a lâmina curva). São o pão do Caminho em todos os ranks.

**2. Maré e gravidade.** O Caminho puxa e empurra. Move alvos, prende no chão, aliviana o próprio corpo, e em rank alto mexe com o peso de coisas que não deveriam se mover. **Falha na lua nova.**

**3. Frio Yin.** Não é dano de gelo — é **lentidão do próprio fluxo**. O frio Yin ataca duas coisas: os reflexos (**−DES**) e **a circulação de essência do alvo** (custo de ativação de Gu aumentado, ou regeneração zerada). É a assinatura tática do Caminho: você não mata o inimigo, você **desliga o motor dele** e mata depois.

---

## Gu do Caminho da Lua

Todos abaixo entram no [[📖 Catálogo de Gu|Catálogo]]. Custo de ativação: Lua é elemental, **×1** (ver [[🏛️ Arquitetura do Sistema|Arquitetura do Sistema]]).

| Gu | Rank | Tipo | Efeito mecânico | Forte / Fraco | Peculiaridades | Alimentação |
|---|---|---|---|---|---|---|
| **Gu da Foice Crescente\*** | 2 | Ataque, à distância | `Ataque: 1d8 × M` (passo +1), alcance 25 m. **Ignora cobertura parcial** — a lâmina curva em volta de escudo, parapeito e aliado interposto. Dois disparos por ativação, o segundo por metade do custo | ⬆️ Alvo atrás de cobertura, ou no meio de aliados · ⬇️ Contra RD alta, o corte raspa: **RD conta em dobro** contra este Gu | ⚡Condicional 🍖Pontual | Luar direto, uma noite por semana. Três semanas sob teto e entra em letargia |
| **Gu do Disco Minguante\*** | 3 | Ataque, à distância | `Ataque: 1d8 × M` (passo +1), alcance 30 m. **Ignora cobertura parcial.** O disco não para no primeiro corpo: depois de acertar, continua e atinge **um segundo alvo a até 5 m do primeiro** com metade do dano (sem novo teste de acerto). Na **minguante**, ricocheteia numa terceira vez | ⬆️ Dois alvos por ativação, sem gastar ação a mais, e curva em volta de cobertura · ⬇️ Precisa de **céu visível na linha do disco**: sob teto ele não abre, e em corredor não há segundo alvo pra achar | ⚡Condicional 🍖Pontual | Luar direto, 1 noite por semana |
| **Gu da Maré Puxada\*** | 3 | Controle | Arrasta todos os alvos num raio de 15 m **8 m em direção a um ponto** que você escolhe. CON contra a CD dos seus Gu pra resistir. Alvos arrastados um contra o outro sofrem `1d6 × M` de impacto. **Não funciona na lua nova nem sem céu visível** | ⬆️ Reagrupa o campo inteiro pra um Golpe Matador de área · ⬇️ Lua nova, ou teto de pedra: morto | ⚡Condicional ⚡Cego | Água que refletiu a lua cheia — um barril por mês, colhido na noite certa |
...
- **Efeito final:** núcleo no passo **+4**, mais **+3 do combo**, mais o modificador de Fase = sob lua cheia é passo **+9: `2d12+1d4 × M`**, em área de 15 m. Quem falhar VON perde regeneração e metade do deslocamento por 3 rodadas.
...
### 🌘 Corte do Minguante *(rank 3–4, econômico)*

...
| **5** | **DESCARGA — +3 Níveis de Dano e o golpe ignora a RD do alvo por completo** |
...
| **Gu da Mão de Pedra\*** | 3 | **Corpo**, permanente | **Grau Médio — exige CON +2.** As mãos endurecem em granito vivo. **Desarmado passa a contar como arma média** (passo 0, `1d6 + FOR`) e **+1 Nível de Dano permanente**; **+2** em qualquer teste de agarrar. Custo pago uma vez no assentamento: 40. Depois, zero essência pra sempre. **Abaixo do mínimo:** `3d8` de dano, **1 Ferimento** e o Gu morre. **Incompatível com** qualquer Gu que exija mãos finas — e **−2 permanente em todo teste de refino** ([[🧩 Refino e Precificação\|Refino]]) | ⬆️ Dano permanente que não come, não desliga e não pode ser roubado. Você nunca está desarmado · ⬇️ O −2 em refino é para sempre e fecha a rota de quem queria refinar os próprios Gu. Escolha de campanha inteira, feita no rank 3 | ⚡Único ⚡Exclusivo 🍖Livre 🔨Sacrifício | — (permanente; não come) |
| **Gu do Tirano de Mil Jin\*** | 4 | Amplificação, sustentado | **+2 Níveis de Dano** no melee · **`RD 1 × M = 8`** passiva · manobra física contra alvos **duas categorias de tamanho acima** (você ergue e arremessa um cavalo, uma porta de portão, uma fera de montaria). Ativação 40, manutenção 8/rodada. **Freio:** a partir da **4ª rodada ativa**, consome **1 de Ímpeto por rodada** pra continuar. Sem Ímpeto, desliga sozinho no fim da rodada | ⬆️ +2 Níveis, RD e arremesso pesado num Gu só. É o motor da fase média do Caminho · ⬇️ Ele **come o mesmo recurso que os seus Golpes gastam**. Manter o Tirano aceso e acumular 5 de Ímpeto pra uma Descarga são objetivos que brigam entre si — e é essa briga que impede o Caminho de ser só "ligue tudo e bata" | ⚡Recuo ⚡Preso | Ferro cru — 5 kg por semana, engolido |
| **Gu da Pele de Bronze** (Bronze Skin Gu) | 1 | Defesa, sustentado | A pele ganha um brilho fosco de bronze. **`RD 1 × M`**. 📕 O romance chama esta série — Pele de Fera, Pedra, Bronze, Ferro, Jade — de *"a escolha da maioria dos Mestres de Gu de combate corpo a corpo"*. É o Gu de defesa **padrão** de quem luta de perto |

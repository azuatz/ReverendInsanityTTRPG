...
O Caminho que ignora o corpo. Armadura não protege, RD não conta, Vitalidade não importa — o dano vai direto no segundo trilho da ficha, e a maioria das construções não tem defesa nenhuma contra isso.

Em troca, é o Caminho que **te muda**. Cada alma devorada deixa alguma coisa pra trás, e o cultivador de Alma que não controla isso deixa de ser ele mesmo antes de deixar de ser vivo.
...
**Custo de ativação:** Alma é ×1,25 (ver [[🏛️ Arquitetura do Sistema|Arquitetura do Sistema]]) — mexer em mente e vontade sempre cobra mais. Um Gu de Alma do seu rank custa **50** em vez de 40.

---

## 🪜 A Força de Alma

A alma de um cultivador se mede **em homens** — quantas almas humanas comuns ela vale. É um número na ficha, começa em **1**, e sobe.

```
Força de Alma (em homens)  →  multiplicador na Alma máxima
```

| Estágio | Força | Alma máxima | Como se alcança | O que destrava |
|---|---|---|---|---|
| **Alma Humana** | **1** | `(16 + 3 × VON + 3 × B) × M` | Todo mundo nasce assim | — |
...
| **Alma de Monstro** | **1.000** | **×4** | **Só depois da Ascensão.** Devorar uma fera desolada ou um Imortal | Ataques de Alma seus ignoram RD de Alma de rank inferior |
| **Alma Desolada** | **10.000** | **×8** | Rank 7+, devorar Imortais repetidamente | A alma **sobrevive à morte do corpo** por `1d6` dias — tempo de alguém te salvar, ou de você tomar outro corpo |
| **Alma Espectral** | **100.000+** | **×16** | Rank 9. Território de um Venerável do Caminho da Alma | Coisas que não têm mais nome de regra |

### 🔴 O teto de Cem Homens — a linha que mata

> **Um corpo mortal comporta no máximo 100 homens de Força de Alma. Passar disso faz a alma estourar, e o cultivador morre na hora.**

Não é dano, não é Teste de Morte, não tem salvamento: a alma inchou além do recipiente e o recipiente era a pessoa. **Só a Ascensão Imortal levanta esse teto** — a Abertura Imortal comporta o que um corpo mortal não comporta, e é por isso que Alma de Monstro pra cima é exclusivo de Imortais.

Isso torna o Caminho da Alma o único do sistema onde **ficar forte demais antes da hora é literalmente fatal**. Um cultivador de Alma em 95 homens está numa corda bamba: cada alma devorada a mais é um passo pra frente ou o fim.

**Rastreamento de mesa:** anote a Força de Alma na ficha ao lado da Alma máxima. Quando passar de 80, o mestre deve avisar em cena — a alma começa a doer, e o personagem sente.

### 🧘 Temperagem — subir sem matar ninguém

Devorar é rápido e sujo. Existem três métodos lentos, e todo cultivador de Alma sério usa os três — porque são os únicos que **não geram Contaminação**.
...
A Força de Alma não serve só pra aguentar dano de Alma:
...
O recurso que faz a Força de Alma subir sem precisar matar ninguém, e o mais perigoso item do sistema.

| | |
|---|---|
| **O que faz** | Consumir uma pedra: **+`1d6` de Força de Alma**, e cura toda a Alma na hora |
| **A sensação** | Prazer extremo, imediato, comparável a droga pesada. O personagem **quer** de novo |
| **O vício** | Depois do primeiro uso, toda vez que uma pedra estiver disponível: **VON CD 14** pra não consumir. A CD sobe **+1 por pedra já consumida** |
| **O risco** | O `1d6` é rolado **depois** de você decidir. Em 96 de Força, um 6 te mata. **Não existe forma de consumir com segurança perto do teto** |
| **De onde vêm** | De um único lugar no mundo — uma montanha ligada ao fundador do Caminho da Alma. Quem controla a montanha controla o Caminho inteiro, e isso é geopolítica |

**A escada é pública entre quem entende.** Um cultivador de Alma de Cem Homens é reconhecível por outro cultivador de Alma na hora, e é tratado como se trata alguém que comeu gente — porque é exatamente isso que ele fez.

---

## 🩸 Devoração e Contaminação

Devorar uma alma é a fonte de recurso do Caminho, e é o preço dele.
...
| Imortal | **+`1d6 × 100`** | Tudo acima · **+500 Marcas**. Só um Imortal sobrevive a isto — num mortal, é morte garantida |

⚠️ **Devorar também pode te matar.** A Força de Alma sobe *antes* de você conferir o total. Um mortal em 90 homens que devora um cultivador de rank 4 rola `2d10` e tem chance real de estourar os 100 na hora. **Devorar perto do teto é roleta.**

Devorar é uma **ação em combate** contra alvo caído/incapacitado, ou uma cena fora dele. A alma precisa estar **fresca** — mais de uma hora depois da morte, ela dispersa.

### O que se paga: Contaminação

```
Cada alma devorada soma Contaminação.
Mortal comum: +1 · Cultivador rank 1–3: +3 · Rank 4–5: +8 · Fera desolada: +10 · Imortal: +25
```

Contaminação é um número na ficha que **só sobe**, salvo purificação. Nos limiares:

| Contaminação | O que acontece |
|---|---|
| **10** | Memórias que não são suas aparecem em sonho. O mestre te conta uma coisa verdadeira sobre a vida de alguém que você comeu |
| **25** | **−1 VON permanente.** Uma das vozes tem opinião, e às vezes ela fala pela sua boca em cena |
| **50** | **Loucura de Devoração:** ao começar qualquer combate, teste de VON CD 15 ou você **ataca o alvo mais próximo**, aliado ou não, na primeira rodada |
| **75** | **−1 CAR e −1 AST permanentes.** As pessoas percebem que tem gente demais atrás dos seus olhos |
| **100** | **Você não é mais o hospedeiro majoritário.** O personagem vira NPC — não morre, mas quem levanta não é quem você jogou |

**Como se purifica:** um Gu de Alma dedicado a limpeza (raro e caro), um arco de reclusão, **ou luz de lua cheia** — ver a seção de sinergia mais abaixo, que é a razão pela qual a combinação Lua + Alma existe.
...
>
> **E note o "passo +1" do Grito Sem Boca:** em d12 não há dado maior, então o passo vira **+1 por dado** ([[⚔️ Combate|a Escada]]), e não d14. É a regra geral da Escada, e valia deixar explícito onde ela aparece.

| Gu | Rank | Tipo | Efeito mecânico | Forte / Fraco | Peculiaridades | Alimentação |
|---|---|---|---|---|---|---|
| **Gu do Verme da Lembrança\*** | 2 | Ataque de Alma | `Ataque de Alma: 2d12` (passo 0), toque ou 5 m. **Ignora RD e armadura.** O alvo revive a pior lembrança dele: falhando VON contra a CD dos seus Gu, perde a ação da próxima rodada | ⬆️ Alvo blindado até os dentes que nunca investiu em VON · ⬇️ Alcance curto: você precisa chegar perto de quem bate mais forte que você | ⚡Marca 🍖Proibida | Uma lembrança sua, entregue de verdade — o Gu come **suas** memórias se não achar outras. Uma por mês |
| **Gu da Agulha Espectral\*** | 3 | Ataque de Alma | `Ataque de Alma: 4d12` (passo 0), alcance 15 m. **Ignora RD, armadura e Defesa física por completo** — a Defesa contra ele é `10 + VON + 2 × rank`. Contra alvo que já tenha sofrido dano de Alma nesta cena, **+1 Nível**. Custo ×1,25 como todo Gu de Alma | ⬆️ A resposta do jogo pra RD alta: um bruto com `RD 2 × M` recebe o dano inteiro · ⬇️ Não derruba ninguém sozinho — contra um **lutador** — o alvo natural dela, porque Vontade é o atributo fraco desse arquétipo — são **~2,9 acertos** para derrubar. Contra um **conjurador de Vontade alta**, sobem para **~4,0**. É desgaste seletivo: curto contra quem não se defende da alma, longo contra quem se defende | ⚡Marca | Fragmento de alma, ou 1 dose de sangue de moribundo por semana |
...
| **Gu do Grito Sem Boca\*** | 4 | Ataque de Alma, área | `Ataque de Alma: 8d12 + 8` (passo +1 — em d12 o passo vira +1 por dado) em **todos num cone de 12 m**, alcance por VON contra a CD dos seus Gu (não há teste de acerto). **Ignora RD, armadura e Defesa física.** Quem falhar fica também **Amedrontado por 1 rodada** — não pode se aproximar de você. Custo ×1,25 | ⬆️ Ataque de rank próprio que atravessa qualquer blindagem e resolve uma linha inimiga inteira · ⬇️ ⚡`Cego`: **pega aliados no cone**, e a **Contaminação sobe 1 por uso** (ver *Devoração e Contaminação*, nesta nota). Contra alvo com Gu de defesa de Alma ativo, o dano cai pela metade | ⚡Cego ⚡Ruidoso ⚡Recuo | Uma alma pequena por uso — inseto, ave, rato. Sem isso, come um pedaço da sua |
...
| **Gu da Voz Sem Dono\*** (Ownerless Voice Gu) | 5 | Ataque de Alma, alvo único | Uma voz que o alvo reconhece e não consegue nomear fala dentro do crânio dele. `Ataque de Alma: 16d12` (passo 0), alcance 30 m. **Ignora RD, armadura e Defesa física por completo** — a Defesa contra ele é `10 + VON + 2 × rank`. Contra alvo que **já sofreu dano de Alma nesta cena**, **+1 Nível** (continuidade com a Agulha Espectral). Contra alvo sob **Frio Yin**, o teste de VON dele é com **desvantagem** e a RD de Alma dele conta pela metade — a sinergia Lua + Alma que já é regra. Custo ×1,25 como todo Gu de Alma | ⬆️ O ataque de execução de alvo único que o Caminho não tem no topo da fase mortal: passa por RD 64, por armadura de rank 5 e por qualquer Gu de defesa físico, e **não pega aliado nenhum** — que é o defeito do Grito Sem Boca · ⬇️ **Cada uso soma +2 de Contaminação** (o dobro do Grito Sem Boca: a voz é uma alma armazenada gastando-se). Contra alvo com Gu de defesa **de Alma** ativo, o dano cai pela metade. E a voz **não é anônima**: quem sobrevive sabe que foi um cultivador de Alma, o que é acusação suficiente na maioria das facções | ⚡Marca ⚡Recuo 🍖Rara | Uma alma de cultivador **armazenada e não digerida** por ativação. Sem estoque, o Gu come um pedaço da do usuário: **−1 de Alma máxima permanente por disparo a seco** |
| **Gu da Alma de Cem Faces\*** | 5 | Utilidade / Social | Você acessa a memória e os maneirismos de qualquer alma que tenha devorado: **+6 pra se passar por essa pessoa específica**, e responde perguntas sobre a vida dela como se fosse ela. Contra quem a conhecia de perto, AST CD 24 pra desmascarar | ⬆️ Infiltração perfeita em qualquer lugar onde alguém que você comeu tinha acesso · ⬇️ Só serve pra quem você já devorou — e usar isso conta como **+1 Contaminação por cena**, porque você a está deixando dirigir | ⚡Viciante ⚡Recuo | As próprias almas armazenadas |
| **Gu Imortal da Alma Devorada\*** | 6 | Ataque de Alma | `32d12` (32–384) de dano de **Alma** num alvo, alcance 60 m. Se o dano **matar**, a alma é automaticamente devorada e você recupera **metade da Essência Imortal máxima**. Contaminação normal do alvo, +10 | ⬆️ Mata e reabastece no mesmo golpe — o motor de uma guerra de desgaste sozinho · ⬇️ Contra quem tem RD de Alma ou VON alta, é caríssimo e ineficiente. E cada uso é um passo a mais na Contaminação | ⚡Recuo 🍖Canibal 🔨Sacrifício | 15 UV, mais **uma alma de cultivador por trimestre** — não serve alma de mortal comum |

## Golpes Matadores do Caminho da Alma

### 👁️ Julgamento das Cem Vozes *(rank 4–5)*
...
### 🕯️ Recolher o Que Sobrou *(rank 3+, defensivo)*
...
> **Sob lua cheia, a céu aberto, uma noite inteira de reclusão queima `1d6 + nível de domínio em Lua` pontos de Contaminação.**

Esta é a peça central da build. O Caminho da Alma sozinho **é uma corrida contra a própria Contaminação** — devorar é a fonte de recurso e o veneno ao mesmo tempo, e todo cultivador de Alma acaba escolhendo entre poder e identidade.

Com Lua, você tem uma **válvula**. Não é infinita (uma noite de lua cheia por ciclo lunar, e o dado é pequeno), mas transforma "quantas almas até eu deixar de existir?" em "consigo limpar mais rápido do que sujo?". Isso é uma pergunta muito melhor de se jogar.

**A tensão que isso cria:** limpar exige lua cheia e céu aberto — **uma noite específica por mês, num lugar exposto, sem se mover**. É a janela mais previsível que um personagem pode ter, e todo inimigo que estudar você vai saber exatamente onde você estará. O Caminho da Lua te dá a cura e entrega o seu calendário pro inimigo no mesmo pacote.
...
*(A versão anterior **somava as duas contagens** para determinar o domínio de ambas, o que valia +1 patamar inteiro de graça. Revogada duas vezes e por motivos independentes: a **decisão 227** tirou a fusão até como Buff de Lore, e a **254** a tornou incoerente ao desacoplar Marca de Domínio. Texto arquivado em [[Regras removidas (2026-09-01 — varredura de texto)]].)*

### 3. O frio Yin abre a alma

Um alvo sob efeito de **Frio Yin** (do [[🌙 Caminho da Lua|Caminho da Lua]]) tem a circulação de essência travada — e a alma dele fica exposta:

> Alvo sob Frio Yin sofre **desvantagem em todo teste de VON contra Gu de Alma**, e a RD de Alma dele conta **pela metade**.

Isso faz a sequência canônica da build: **esfria primeiro, devora depois.** O Gu do Frio de Osso não é suporte genérico — é a preparação específica do golpe de Alma, e é o que transforma dois Caminhos separados numa coisa só.

...
| **Gu da Agulha Espectral\*** | 3 | Ataque de Alma | `Ataque de Alma: 4d12` (passo 0), alcance 15 m. **Ignora RD, armadura e Defesa física por completo** — a Defesa contra ele é `10 + VON + 2 × rank`. Contra alvo que já tenha sofrido dano de Alma nesta cena, **+1 Nível**. Custo ×1,25 como todo Gu de Alma | ⬆️ A resposta do jogo pra RD alta: um bruto com `RD 2 × M` recebe o dano inteiro · ⬇️ Não derruba ninguém sozinho — a barra de Alma de um lutador de VON 0 no rank 3 são 64 pontos, e você tira ~26 por acerto — **41% da barra**, ou seja **~2,5 acertos** para zerá-la, que é exatamente o que o degrau d12 promete | ⚡Marca | Fragmento de alma, ou 1 dose de sangue de moribundo por semana |

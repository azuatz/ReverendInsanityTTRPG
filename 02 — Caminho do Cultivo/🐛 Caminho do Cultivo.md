...
## Nível 1 — Antes da primeira sessão *(leia estas quatro)*

Sem elas você não consegue rodar a criação de personagem nem responder "como eu fico mais forte?".

1. **[[🪜 Ranks e Estágios]]** — os 9 ranks e os 4 estágios dentro de cada um. A **Densidade da Essência** aqui é o que define, em cada estágio, quanto dano por dado, quanta Vitalidade, quanta Alma, quantas Vagas de Suporte. **É a tabela mais consultada do sistema.**
...
Não leia os seis. **Leia só o do Caminho que apareceu na sua mesa.**

| Caminho | O que ele faz de diferente |
|---|---|
...
Aqui está o **maior evento do jogo**. Leia com algumas sessões de antecedência, não na véspera.

1. **[[♾️ A Ascensão Imortal]]** — o gargalo: os dois portões obrigatórios, os Três Ares, a provação de 5 testes. **Tem risco real de morte.**
2. **[[🧿 Espíritos da Terra]]** — a trava do primeiro Gu Imortal. As 3 atitudes do Espírito e o preço que ele cobra.
3. **[[🗝️ Terra Abençoada]]** — o território pessoal do Imortal: tamanho decidido na Ascensão, fluxo de tempo e essência, 4 camadas, Ferimentos da Terra.
4. **[[☯️ Marcas de Dao]]** — depois do rank 6, **as Marcas substituem os estágios** como medida de perigo. 6 níveis de domínio, 4 fontes, e o preço.
...
- **[[🌾 Ecologia e Economia da Terra Abençoada]]** — a fenda como ecossistema e fazenda: Sintonia elemental, cadeia alimentar, Ração dos Gu Imortais, Desequilíbrio e o Ciclo Anual.

---

## Fora desta pasta, mas ligado

- **[[🤝 O Débito]]** *(em [[🗡️ Arsenal|05 — Arsenal]])* — favores vinculantes com retaliação real. É como um personagem consegue o que a aptidão dele não permite.
- **[[🪱 Gu|03 — Gu]]** — o rank diz o que você **pode** usar; a coleção de Gu diz o que você **faz**. As duas pastas se leem juntas.

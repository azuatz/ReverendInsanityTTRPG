...
Vitalidade máxima EFETIVA = (12 + 3 × CON) × M − Dívida de Sangue
```
...
Compare a Dívida com a Vitalidade máxima **cheia** (`(12 + 3 × CON) × M`, sem descontar nada):
...
|---|---|---|---|---|---|---|
| **Gu da Agulha Vermelha\*** | 2 | Ataque, à distância | `Ataque: 1d8 × M = 1d8×2` (passo +1), alcance 15 m. **Sangria 1 × M = 2**. Contra alvo que já esteja sob *Sangramento* ou abaixo de metade da Vitalidade, **+1 Nível** — a agulha puxa o sangue que já está solto. Ativação 20 de essência | ⬆️ Ataque à distância barato num Caminho que a maioria supõe ser só corpo a corpo · ⬇️ Cada disparo é 10% da sua barra num rank 2. Sem alvo sangrando, é um Gu de rank 2 comum e caro em corpo | ⚡Recuo ⚡Marca | Sangue fresco, uma dose por semana. Aceita sangue de gado |
| **Gu do Torniquete Vivo\*** | 3 | Cura, toque | Toca um alvo a 2 m e recupera `1d6 × M = 1d6×4` de Vitalidade nele, removendo *Sangramento*. **O valor curado entra inteiro na SUA Dívida de Sangue** — você não gasta Vitalidade agora, você empresta teto. Não cura ninguém acima do máximo efetivo dele. Ativação 20 | ⬆️ O melhor curandeiro de campo do rank 3, sem depender de Caminho da Água. Numa expedição longa, mantém o grupo inteiro de pé · ⬇️ Curar quatro aliados numa luta te coloca em **Lívido** e você luta o resto da campanha assim. O Caminho cura os outros com o seu corpo | ⚡Recuo | Sangue fresco, duas doses por semana |
...
- **Efeito final:** núcleo no passo **+5**, mais **+3 do combo**, mais **+3 do Manto** = passo **+11**, `2d12+1d8 × 16`, ignorando RD, contra um alvo com desvantagem pra resistir. Custo de essência: `(20+20+20+20) × 4` = **320** — ridiculamente barato pro que entrega, porque é Caminho único e ×0,5.
...
- **Efeito final:** passo **+2** do combo sobre o dreno das Correntes (`1d10 × 4` por alvo por rodada em vez de `1×M`), três alvos, 2 rodadas — e **tudo isso quita Dívida ponto por ponto**. Contra um grupo de três, devolve até ~90 de Dívida.

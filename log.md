...
## [2026-09-01] simulação | A DES dos moldes revalidada em cena (decisão 294)
Verificação do único item da 293 que publiquei medindo só probabilidades. Dar DES aos moldes muda quem abre a rodada (+4pp Guerreiro/Mestre, +9pp Elite, +14pp Chefe contra um PJ de DES +2), mas o que isso vale em vitória não é dedutível — a iniciativa é sorteada uma vez por cena e não muda o número de ações, só a ordem. Medido com a DES viva no motor, quinze células dos ranks 1, 3 e 5: as quinze continuam na faixa. O custo é pequeno e concentrado onde faz sentido — Fácil e Padrão não se movem, e o preço aparece em Difícil (−2,5 a −5,4pp) e Clímax (−0,6 a −3,3pp), as composições com mais peças e mais ações por rodada. A célula mais afetada é o Difícil r5, de 61% para 56%, dentro da faixa de 40-75%. Nenhum ajuste necessário. Observação de método: publicar verificando só a probabilidade é a mesma armadilha da 267 — a aritmética dizia "o Chefe abre 14pp mais vezes" e não dizia o que custa; a cena disse.

## [2026-09-01] ingest | A ficha de inimigo fechada, e um número meu corrigido (decisão 295)
Segunda passada do playtest: nove rodadas de combate, motor não travou uma vez. (a) Erro meu: a sessão paralela apontou que a DERIVAÇÃO da Defesa contra Alma não fechava; conferindo contra o motor, o VALOR é que estava errado — publiquei 13+rank e o real é 13+2×rank. Um molde de rank 5 defendia com 18 em vez de 23. Corrigido, e a derivação agora fecha: é a fórmula do PJ com VON +3, a linha de base da 252. O erro só apareceu porque alguém questionou a explicação e não o número — uma derivação que não fecha é sintoma. (b) Cinco dos seis moldes não publicavam barra de Alma: o playtest mediu o PJ de Alma acertando 5 de 5, gastando 79% do tanque, e nada acontecendo. Publicada como uma linha: a barra de Alma de qualquer molde é 95% da Vitalidade. A Horda é exceção legítima. (c) O molde Chefe não publicava Defesa, Acerto, RD nem Dano — publicados, com a frase que economiza a tabela: o Chefe é um Elite com quatro números próprios. (d) Acrescentado o Recruta à escada de DES. Validação: o Clímax de rank 1 rodou 7 rodadas e venceu com uma baixa, contra os 69% em 6,5 rodadas prometidos.

## [2026-09-01] ingest | Alma zerada de inimigo: fora da cena, corpo intacto (decisão 296)
Publicada antes da terceira passada tropeçar nela — a instrução dela pede "dizer o que acontece quando a barra de Alma do molde zera", e o vault só documentava o Colapso Espiritual para personagens. O motor sempre soube: enemy_alive devolve falso com Alma a zero, e as 26 rodadas todas tiraram o inimigo da cena assim. Publicado com o motivo da assimetria escrito, para ninguém "consertar": o PJ tem a rede do Colapso porque a mesa precisa que ele volte; um molde é peça de cena. A consequência de desenho estava invisível e é grande: um inimigo derrubado pela Vitalidade está morrendo, um derrubado pela Alma está inteiro, inconsciente e no chão — a diferença entre cadáver e prisioneiro, pelo mesmo número de acertos. Isso faz do Caminho da Alma a via de captura do sistema e fecha o círculo com o Coletivo canônico, "o método de captura número um", que não causa dano nenhum.

## [2026-09-01] lint | Playtest de leitura em três passadas: o sistema está jogável (decisão 296)
Três agentes leram o vault como o mestre que nunca leu o romance, executando em vez de avaliando — montando ficha, rolando iniciativa, resolvendo dano. A primeira passada travou em três números ausentes da ficha de inimigo: nenhum molde tinha Destreza (e iniciativa é d20+DES), nenhum tinha Defesa contra Alma, e não existia deslocamento base publicado — o que tornava a condição Lentidão inerte, aplicada três vezes sem efeito nenhum. A segunda travou em quatro: a Lentidão nova convivendo com a revogada na própria seção que leva o nome dela, o molde de Chefe sem Defesa/Acerto/RD/Dano, e cinco dos seis moldes sem barra de Alma. A terceira, cega de propósito e instruída a contar invenções em vez de opinar, fechou em ZERO invenções e vitória nos dois combates previstos. A tabela de composição previu a mesa duas de duas: Padrão em 4 rodadas contra 4,2-5,1 previstas, Clímax em 6 contra 6,5 — primeira validação do dia vinda de uma mesa em vez de 3.000 iterações. Sobraram quatro incômodos não bloqueantes, sendo o mais relevante que o Caminho da Alma não é jogável no rank 1 e ninguém avisa na sessão zero. Revisão Final atualizada com o veredito.

## [2026-09-02] canon | Essência imortal é pessoal e intransferível — achado 1 da revisão externa (decisão 297)
Chegou a revisão externa da sessão que mantém a Bíblia de Sistema, produzida a partir da leitura integral do romance. O primeiro achado é erro contra a obra e o de maior retorno: o vault dizia que um Imortal podia comprar, roubar ou receber essência de rank acima, e na obra essência alheia simplesmente não se usa — ela carrega a vontade de quem a produziu. Conferi as quatro citações na fonte primária antes de aplicar (caps. 638, 1625, 666 e 971), todas literais. Publicada a distinção que resolve o assunto: a Pedra de Essência Imortal é moeda e circula, a conta do próprio núcleo é pessoal, e a conversão é sempre para o rank de quem converte. Publicadas as quatro exceções canônicas, com destaque para a Casa de Gu Imortal, que absorve de qualquer fonte e passa a ser a única razão mecânica para um grupo de Imortais agir junto. O achado retira complexidade em vez de acrescentar: fecha a porta de "comprar essência", que estava aberta e sem preço, e devolve ao custo de ativação o papel de único freio da fase imortal. Aplicado em quatro notas existentes, nenhuma nota nova.

## [2026-09-02] simulação | O Coletivo remedido — a última pendência numérica do vault (decisão 298)
Refeita a medição do preço da captura do Golpe Matador Coletivo, que estava marcada como provisória desde que se descobriu o bug de motor de ontem. A sessão que tinha o simulador encerrou, então rodei aqui: mesmo script, mesma seed, mesmo N, trocando só a escada de Níveis das fichas para o estado de paridade ordinária. O achado é que o erro não era ruído e sim viés — em 20 das 24 células o valor corrigido é menor que o publicado, com correções de 1,9 a 10,2 pontos percentuais, sempre na mesma direção. O Coletivo parecia melhor do que é. O número publicado de "+26 a +30 pontos de captura" era, na verdade, o de duas tentativas medido com o bug: uma tentativa compra +20 a +24. A leitura de desenho sobrevive intacta — o de dois é ferramenta tática barata, o de três e o de quatro são desespero, e o de quatro chega a piorar a captura contra Elites. Etiqueta PROVISÓRIO removida e substituída pela procedência. Script novo roda os dois braços lado a lado para a diferença ser auditável.

## [2026-09-02] crítica | O Fantasma de Fera reprovado em mesa e reescrito de novo (decisão 299)
Rodei um playtest só sobre a regra que eu tinha reescrito horas antes a partir da revisão externa. Ela reprovou: doze invenções, sete dentro dela. A regra mandava consultar "família de lei" e "estilo de golpe", e nenhum dos dois existe como campo no vault — a tabela de chance consultava algo inexistente, e a build que ela prescrevia não tinha produto no Catálogo. Estava correta em canonicidade e inexecutável em mesa. Reescrita para usar só o que existe: gatilho é Ímpeto em 4 ou 5, e a chance conta quantos Gu de Corpo diferentes trazem fera — cada ficha do Catálogo já nomeia o bicho. Duas correções de balanceamento vieram da própria medição: a Descarga dispara menos de uma vez por combate e não servia de gatilho, e o −2 no acerto anulava os +2 Níveis, deixando o Fantasma valendo 2,4% de dano. Consertados também um link para seção revogada e três nomes de Gu no plural que o Catálogo registra no singular. A lição: a regra passou por conferência canônica, revisão externa e minha reescrita, e só caiu quando alguém tentou rolar os dados.

## [2026-09-02] ingest | Densidade paga removida e a curva de essência achatada (decisão 300)
Diretiva do autor, com um diagnóstico melhor que o das quatro rodadas de calibragem anteriores: a escolha de densidade por ativação era falsa em metade do catálogo, porque num Gu de defesa, movimento ou utilidade não há dano para comprar — o jogador pagava sempre o mínimo e a pergunta virava imposto de leitura. As medições anteriores todas afinaram a dose e nenhuma perguntou se a escolha existia. Custo de Gu passa a ser fixo pelo rank; o B volta a ser automático. O problema que a regra existia para resolver — essência deixar de restringir nos estágios altos — foi resolvido achatando a reserva: agora cresce 50% por estágio (100/150/200/250%) em vez de dobrar (100/200/400/800%). O multiplicador não foi escolhido: o cenário de calibragem que o autor deu (rank 4 Inicial mata metade da luta, Médio metade mais dano, Alto os dois sem sobra, Pico os dois com sobra) traduz-se exatamente em 1 : 1,5 : 2 : 2,5. Com aptidão 76% o Pico cai de 60,8 para 19,0 ativações. Propagado em 13 notas para a fórmula e 8 para a remoção da compra.

## [2026-09-02] ingest | Levantamento contra a Bíblia de Sistema — sete peças importadas (decisão 301)
Três frentes em paralelo (regras, Gu, golpes matadores) comparando o sistema contra as 435 notas da Bíblia, com o filtro do autor embutido: o sistema já está cheio. O resultado principal é o descarte — ~741 Gu mortais testados, dos quais ~120 já estavam aqui traduzidos com outro rótulo, e 48 de 60 candidatos de regra descartados por já existirem sob outro nome. A margem de ganho está em profundidade, não em cobertura. Importados: os quatro pares canônicos de conflito de Caminhos que passam por cima da tabela Yin/Yang (Força × Luz era "complementar, sem penalidade", e o cânone diz que o Gu de Luz falha e se destrói); a origem e o relógio das Terras Abençoadas herdadas, que era o exemplo do próprio autor; a carga de Gu selvagens de uma fera, que fechou a contradição de o Mercado prometer a via Caçar enquanto o Espólio dizia que fera não dá Gu; o golpe que queima com o uso, ligando repetição à CD da Brecha e dando razão ao custo de reclusão; a interrupção com retorno crescente; carne modificada curando pela metade; e a tribulação como Golpe Matador de um Venerável morto, o que lhe dá Brecha pesquisável. Ficaram fora doze Gu de Vento, as rotas lunares e os Gu-fonte, porque mexem em número e exigem simulação.

## [2026-09-02] canon | A roda dos cinco elementos é 🔧 Adaptada, e agora está marcada (decisão 302)
Digesto tardio da Bíblia alegou que o romance não tem ciclo de cinco elementos. Conferido na fonte primária antes de virar parecer, e procede: os cinco Caminhos existem e há quem cultive os cinco, mas a interferência entre Caminhos lá é por densidade de Marcas, mútua e sem direção fixa — o texto tem Marcas de Terra mais densas segurando as de Fogo, o que a roda clássica não autoriza. A roda foi mantida, porque a densidade já existe no vault e não produz decisão nenhuma, enquanto a roda é a única jogada característica do Caminho. O que mudou foi a etiqueta: a seção do ciclo abre agora com o veredito, a evidência e a saída para quem quiser rodar estrito ao romance. Lição: peça sem etiqueta de canonicidade é lida como canônica, e Wu Xing escapou dez meses por ser culturalmente familiar.

## [2026-09-06] ingest+lint | Segunda leva da Bíblia: dez peças, e o lint mecânico do vault (decisão 303)
Aplicados os dez achados que a decisão 301 tinha deixado para depois. O padrão entre eles é que quase nenhum inventa mecânica: eles dão causa, relógio ou saída a coisas que o vault já cobrava sem explicar. Corrigida a contradição mais séria — o vault dizia que Espíritos da Terra mentem, e no cânone eles são sinceros mas envenenáveis; a imunidade ao Caminho da Alma que vem junto foi resolvida transformando o cultivador de Alma de arma em tradutor, para ele não ficar de fora do clímax. Entraram ainda o nó de comando da horda (terceira saída para uma maré, cobrada em perícia e não em Vitalidade), o selo de Gu das heranças (que troca "vamos entrar?" por "vamos entrar quando?"), a régua de viagem (o vault não tinha nenhuma), a nascente como razão de existir do clã, o terreno saturado como gerador de lugar, a anexação como segunda rota de rank com fragilidade já modelada, e a lista de bloqueios da Dedução. Oito das dez foram para notas existentes; nenhuma nota nova.
Lint mecânico em paralelo: 126 notas varridas, zero link quebrado, zero órfã, zero alias duplicado. Corrigidas 4 âncoras de seção e o frontmatter dos 7 templates de _Modelos; os dois callouts do Fantasma de Fera viraram headings para as 5 âncoras que apontavam para eles resolverem; a nota-mãe 🧰 Modelos ganhou linha no Mapa.

## [2026-09-06] crítica+simulação+lint | Varredura de fechamento para envio ao mestre (decisões 304–308)
Cinco frentes em paralelo. As quatro pendências de motor foram medidas e fechadas (304): C+A recusada porque os números que a sustentavam tinham sido medidos contra um alvo de VON 0 que não existe na mesa; controle de Caminho d8 passa a durar 2 rodadas, que é o que faz o degrau se pagar; a Retaliação do Coletivo fica no piso, escolha que vale 32 pontos de vitória; e o B excedente ganha teto de +2, que é onde a cena deixa de ter rodadas suficientes para qualquer decisão. Dois defeitos do próprio motor registrados (305). O catálogo recebeu duas peças de Vento, o Gu Fonte e três correções lunares, com seis recusas (306) — inclusive a descoberta de que três das quatro rotas lunares já estavam no vault com outros nomes. Golpes Matadores ganharam promoção a formação, a Brecha de sensoriamento e a massa consumível (307). E a varredura de envio (308) achou o buraco mais perigoso do vault: nenhuma nota dizia quantas ações um personagem tem por turno, embora todo molde de inimigo declarasse as dele e as 26 rodadas de balanceamento tenham rodado com uma. Corrigidos junto o resíduo das decisões 266 e 300 nas notas de porta de entrada, o teto de 16 dados que nunca foi propagado, um erro de digitação que dava a um Gu de rank 5 o dano de um Venerável, a falta de regra de emboscada, e o vazamento dos PJs da campanha para as pastas de sistema.

## [2026-09-06] otimização+lint | Ficha de ameaças enxugada e verificação final em zero (decisão 309)
A nota que o mestre lê antes da primeira briga tinha 424 linhas, boa parte delas arqueologia de simulação. Vinte e cinco blocos migraram para a nota de Resultados, sete foram separados entre a frase operacional e o histórico, e a ficha fechou em 296 linhas com o mesmo conteúdo jogável e nenhum número alterado. A parada acima do alvo pedido foi deliberada: chegar a 240 exigiria mover seções inteiras, o que não muda nada na mesa. Verificação final sobre as 174 notas vivas: zero link quebrado, zero âncora, zero frontmatter incompleto, zero alias duplicado. Duas lições de método minhas nesta etapa — meu primeiro verificador produziu 51 falsos positivos por ler tags como aliases e por excluir do índice pastas para as quais os links legitimamente apontam; e a âncora ambígua foi resolvida procurando no vault um caso que já funciona, em vez de adivinhar.

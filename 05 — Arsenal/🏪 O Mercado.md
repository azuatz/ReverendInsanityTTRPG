...
```
d20 + modificador do lugar   vs   CD do rank procurado
```
...
```
Vendendo a um refinador ou mercador: 40% do preço de tabela
```
...
- **3 a 5 lotes**, de rank variado, normalmente até **1 acima** do rank do grupo. Leilão é onde se vê o que ainda não se pode ter.
- **Lance mínimo = preço de tabela.** Cada rodada de lances sobe **~20%**.
- Compradores NPC competem, e **quem paga demais por quê revela intenção** — é uma cena política tanto quanto econômica.
- **Todo lote de leilão rola Proveniência.** É a origem do lote que vira o gancho da sessão seguinte.

O leilão é a única forma confiável de um grupo mortal ver um Gu de rank 4 antes de ter rank 4. Também é a forma mais confiável de o grupo ficar devendo dinheiro para alguém perigoso.

---

## A Proveniência — todo Gu comprado teve dono

Role `1d6` sempre que o grupo comprar num leilão, num mercado negro, ou qualquer Gu de rank 3 ou acima.

| `1d6` | De onde veio |
|---|---|
| **1** | Limpo. Refinado para venda, sem história |
| **2** | Espólio de uma expedição que deu errado. **Um sobrevivente** quer de volta |
| **3** | Era de um clã que ainda existe, e que considera aquilo **propriedade roubada** |
| **4** | O dono anterior morreu do que o Gu faz. O vendedor sabia e não disse |
| **5** | Está **marcado** — alguém plantou uma forma de rastrear quem o carrega |
| **6** | O dono anterior não está morto. Ele está **procurando** |

Um resultado 2 a 6 não estraga o Gu: ele funciona perfeitamente. Só vem com alguém junto, mais cedo ou mais tarde.

---

## As quatro vias de aquisição

Comprar é a via mais fraca das quatro, e o sistema é assim de propósito — o pilar *a coleção é a identidade* não sobrevive se a coleção sair de uma loja.

| Via | Custa | Arrisca | Entrega |
|---|---|---|---|
| **Comprar** | Pedras Primordiais | Só a Proveniência | O que o mercado tem, não o que você quer |
| **Refinar** — [[🧩 Refino e Precificação]] | Material, tempo, e um teste estendido | Explosão, perda do material, retrocesso | **Exatamente** o que você quer, se tiver a receita |
| **Caçar** | Uma sessão inteira | Combate de verdade | Gu selvagens — os únicos **sem dono anterior**, e portanto sem Proveniência |
| **Espólio** — [[⚰️ Espólio]] | Um cadáver | A Detonação, e quem vem cobrar | O arsenal montado de outra pessoa, se sobrar algo |

**O primeiro Gu de um personagem nunca é comprado.** Ele vem da Origem ([[🌱 Origens]]), até o fim da sessão 2, e é uma cena. Depois disso o grupo escolhe a via, e a escolha diz o que eles são: quem compra tem clã, quem refina tem paciência, quem caça tem fome, e quem saqueia tem inimigos.

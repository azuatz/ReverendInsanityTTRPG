...
def simulate_calibration_1de4():
    """
    Rodada de calibração extra: se 2-de-4 no Difícil sair fora da faixa-alvo
    (50-75%), testa 1-de-4 (só 1 Mestre com especial de Alma em 4).
    """
    print("\n" + "=" * 88)
    print("CALIBRAÇÃO EXTRA — Difícil com só 1 de 4 Mestres usando especial de Alma")
    print("=" * 88)
    results = {}
    for rank in (1, 2, 3, 5):
        win, surv = simulate(rank, "dificil_corrigido_1de4")
        results[(rank, "dificil_corrigido_1de4")] = (win, surv)
        print(f"  rank {rank}  dificil_corrigido_1de4  vitória {win*100:5.1f}%   sobreviventes {surv:.2f}/4")
    return results
